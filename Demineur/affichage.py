    ...
    for column in range(SIZE_X):
        for row in range(SIZE_Y):
            ...
            bouton.bind("<Button-1>", 
                        lambda event, g = grille, b = boutons, r = row, c = column, cpt = compteur : 
                        clic_gauche(event, g, b, r, c, cpt)) # commande pour clic gauche
...
def clic_gauche(event, grille, boutons, row, column, compteur): 
